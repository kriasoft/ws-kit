...
| [036](./036-unified-error-handling-core-primitive.md)       | Unified Error Handling — `ctx.error()` as Core Primitive | **Proposed**   | Core—Unified error method for all contexts              | [error-handling.md](../specs/error-handling.md), [router.md](../specs/router.md)         |
