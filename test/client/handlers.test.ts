 ...
 *
 * See @client.md#Multiple-Handlers
 * See @client.md#message-processing-order
 * See @implementation-status.md#GAP-005
 * See @constraints.md#inbound-message-routing
 */
...
describe("Client: onUnhandled Hook", () => {
  ...
  it("validation failures are dropped (never reach onUnhandled)", async () => {
    ...
    try {
      ...
      // Per @client.md#message-processing-order:
