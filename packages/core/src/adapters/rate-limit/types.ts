...
/**
 * Rate Limiter adapter interface and types.
 *
 * Defines the contract for rate limiting backends:
 * - Memory: in-process token bucket
 * - Redis: distributed token bucket with Lua atomicity
 * - Durable Objects: per-shard token bucket
 */
