...
/**
 * Symbol for Valibot payload schema.
...
/**
 * Attach schema options to a Valibot schema without polluting the public API.
...
/**
 * Retrieve schema options attached to a Valibot schema.
 ...
 * Call this whenever you create a derivative schema via transform, fallback, etc.
 *
...
/**
 * Get Valibot payload schema from a schema.
 * @internal
 */
export function getValibotPayload(schema: any): any {
